...
- **Transparent Auto Crop**: Optionally trim transparent pixels before resizing, with tight or square crop behavior
...
7. **Configure Transparent Auto Crop**: Enable trimming for transparent PNGs and choose either tight bounds or a square crop area
8. **Preview and Download**: See the result and download your processed image
...
- **Transparent Auto Crop**: Trim empty transparent space before applying crop/scale
- **Crop Shape**: Choose "Crop transparent bounds" to crop independently on both axes, or "Keep square aspect ratio" to preserve a square source region
...
- **Transparent Auto Crop**: Detects the non-transparent pixel bounds and uses that source region for all outputs before applying Cover or Contain
