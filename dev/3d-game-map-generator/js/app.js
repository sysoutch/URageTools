  ...
  return [
    {
      ...
      sourceDetail: "Rendered blockout preview from 3D Game Map Generator.",
      metadata: { sourceTool: "3d-game-map-generator", mode: state.mode, projection: state.projection }
    },
    {
      kind: "text",
      ...
      sourceDetail: "Structured 3D blockout data from 3D Game Map Generator.",
      metadata: { sourceTool: "3d-game-map-generator", resourceFormat: "blockout-json" }
    }
  ];
}
